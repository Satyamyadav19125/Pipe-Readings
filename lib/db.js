...
export const DEFAULT_SETTINGS = {
  ...
  redFlags: {
    ...
    inside_out_of_range: true, outside_out_of_range: true,
  ...
  pipe: {
    // Physical pipe parameters (mm). Used by the range red-flag rules and
    // editable in Settings -> Pipe parameters.
    maxInsideMm: 400,   // highest valid water-level reading inside the pipe
    outsideMinMm: 100,  // expected minimum pipe height above the soil
    outsideMaxMm: 300,  // expected maximum pipe height above the soil
  },
  reading: {
    target: 2,
    periodLabel: 'week',
